        ...
        <div class="page-wrapper">
                        ...
                        <div class="navbar col-sm-12" role="navigation">
                            ...
                            <div class="collapse navbar-collapse pull-right">
                                <ul class="nav pull-left">
                                    ...
                                    <li><a href="<?php echo $site;?>developers">Developers</a></li>
									<li><a href="<?php echo $site;?>developers/api">Api</a></li>
            ...
            <section class="header-11-sub bg-midnight-blue">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-4">
                            <h3 style="color:white">B89.in URL shortner to earn money.</h3>
        
                            <div class="signup-form">
                                <form action="register" method="post" autocomplete="off">
                                    <div class="form-group">
                                        <input class="form-control" name="email" type="email" placeholder="Your E-mail" required aria-invalid="true" maxlength="200" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <div>
                        ...
                        <div class="col-sm-7 col-sm-offset-1 player-wrapper">
							...
							<p style="color:#5050FF; font-size:22px;">
                                At here, you can create shorten links of your long URL and can earn upto <b>$5</b> for each <b>10,000</b> visted links.
                            </p>
								<ul class="animated" style="font-size:18px; color:rgb(247,113,120)">
									<li><span>Easy setup for links,</span></li>
									<li><span>Referral program to earn more money,</span></li>
									...
									<li><span>Hold your payments till you want,</span></li>
                        ...
                        <div class="col-sm-4">
                            <div class="plan">
                                ...
                                <div class="description">
                                    ...
                                    <b>Earn</b> per link<br>
                                    <b>$3</b> for 10,000 visited links<br>
                        ...
                        <div class="col-sm-4">
                            <div class="plan">
                                ...
                                <div class="description">
                                    Create <b>Unlimited</b> links/month<br>
                                    <b>Earn</b> per link<br>
                                    <b>$4</b> for 10,000 visited links<br>
                                    <b>Status</b> of your links<br>
                        ...
                        <div class="col-sm-4">
                            <div class="plan">
                                ...
                                <div class="description">
									...
									<b>Earn</b> per link<br>
                                    <b>$5</b> for 10,000 visited links<br>
                                    <b>Status</b> of your links<br>
									<b>Pay</b> every month<br>
                                    Email support 24*7
                                </div>
                                <a class="btn btn-primary" href="<?php echo $site;?>login?plan=bus">Change to this Plan</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer class="footer-2 bg-midnight-blue">
                <div class="container">
                    <nav class="pull-left">
						...
						<ul>
                            <li class="active">
                                <a href="<?php echo $site;?>developers">Developers</a>
                            </li>
                            <li>
                                <a href="<?php echo $site;?>developers/api">Api</a>
                            </li>
                            <li>
