...
//send email
if((isset($_POST['to'])) AND (isset($_POST['sub'])) AND (isset($_POST['msg']))) {
...
// Mail it      
	...
	if(mail($to, $sub, $message, $headers)){
		echo 'Mail sent successfully to <u>'.$to.'</u>.';
		exit();
	}
	else{
...
<head>
<meta charset="utf-8">
<title>b89.in &raquo; Admin Email Sending Portal.</title>
...
<script type="text/javascript">function sendEmail(){var to=$('#to').val();var sub=$('#sub').val();var msg=$('#msg').val();$('#result').html('Working <img src="<?php echo $site;?>img/wait.gif" /><br>');$.post('<?php echo $admin_site;?>sendEmail',{to:to,sub:sub,msg:msg},function(data){$('#result').html(data)})}</script>
<?php 
/*
...
$('#result').html('Working <img src="<?php echo $site;?>img/loading.gif" /><br>');
		$.post('<?php echo $admin_site;?>sendEmail', {to:to,sub:sub,msg:msg},
		function(data){
			
			if(data=="1"){
				$('#result').html('Email sent to '+to+'.<br>');
			}
			if(data=="0"){
				$('#result').html('Email sending failure.<br>');
			}
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="<?php echo $admin_site;?>sendEmail">b89.in admin email sending portal</a>
  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
		...
		<li class="active"><a href="<?php echo $admin_site;?>sendEmail"><i class="icon-envelope-alt"></i><span>Send Email</span> </a> </li>
								...
								<form id="sendEmail" class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo $admin_site;?>sendEmail" autocomplete="off">
									<fieldset>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input required type="text" class="span6" id="to" name="to" 
												<?php
												
												if(isset($_GET['mailto'])){
													echo 'value="'.$_GET['mailto'].'">';
												}
												else{
													echo 'placeholder="Email address: \'name@email.com\'">';
												}
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input required type="text" class="span6" id="sub" name="sub" 
												<?php
												...
												if(isset($_GET['sub'])){
													...
													echo 'placeholder="Email subject">';
												}
