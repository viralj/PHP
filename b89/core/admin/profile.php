...
if((isset($_POST['submit'])) AND ($_POST['submit'] == 'submit') AND (isset($_POST['pass']))){
	...
	$profile = $site.'manage/admin/profile';
	...
	echo '<script type="text/javascript" language="javascript">
		function checkusername(){
			...
			if(u != ""){
				...
				hr.open("POST", "'.$admin_site.'profile", true);
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="<?php echo $admin_site;?>profile">b89.in user profile</a>
...
<div class="span12">      		
	      		...
	      		<div class="widget ">
					...
					<form id="edit-profile" class="form-horizontal" method="POST" action="<?php echo $admin_site;?>profile" autocomplete="off">
									<fieldset>
